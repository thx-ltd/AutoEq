...
MEASUREMENT_SOURCE='THX'
PRODUCT='DEMO_hecate_g2pro'
DEVICE='HECATE G2 Pro'

MEASUREMENT_FILE="./measurements/$MEASUREMENT_SOURCE/over-ear/$PRODUCT/$DEVICE.csv"
...
# output directory
OUTPUT_DIR="./results/THX/over-ear"
